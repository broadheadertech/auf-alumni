...
export default function DirectoryPage() {
  ...
  const clearAll = () => router.replace("/directory", { scroll: false });
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-10">
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Verified AUF graduates. Filter by batch, program, city, or search by
          name, company, or skill.
        </p>
        {usingMock && (
        ...
        <section>
          ...
          {allCards.length === 0 ? (
            <EmptyState
              ...
              cta={{ label: "Clear all filters", href: "/directory" }}
            />
          ) : (
